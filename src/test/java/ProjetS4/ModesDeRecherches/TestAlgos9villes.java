...
public class TestAlgos9villes {
    ...
    public void test_13villes_TrackProchesMulti() {
        ...
        assertEquals(2097, test_algos_13villes(trackProchesMulti));
    }
    @Test
    public void test_13villes_TrackProches() {
        TrackProchesV2_1 trackProchesV2_1 = new TrackProchesV2_1();
        assertEquals(2097, test_algos_13villes(trackProchesV2_1));
    }
